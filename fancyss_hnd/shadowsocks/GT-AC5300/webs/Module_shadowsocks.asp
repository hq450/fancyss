...
function set_cron(action) {
	...
	push_data("ss_reboot_job.sh", action, dbus);
}
...
# 需要清空电脑DNS缓存，才能立即看到效果。" cols="50" rows="7" id="ss_wan_black_domain" name="ss_wan_black_domain" style="width:99%; font-family:'Lucida Console'; font-size:12px;background:transparent;border:1px solid #91071f;color:#FFFFFF;" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"></textarea>
										...
										<div id="tablet_4" style="display: none;margin:-1px 0px 0px 0px;border:1px solid #91071f;">
											...
											<table id="conf_table1" style="margin:8px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
												...
												<tr>
													...
													<td>
														<textarea placeholder="填入需要订阅的地址，多个地址分行填写" rows=8 style="width:99%; font-family:'Lucida Console'; font-size:12px;background:transparent;border:1px solid #91071f;color:#FFFFFF;" id="ss_online_links" name="ss_online_links" title="" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"></textarea>
													</td>
												</tr>
												<tr>
											...
											<table style="margin:8px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
												...
												<tr>
													...
													<td>
														<textarea placeholder="填入以ss://或者ssr://或者vmess://开头的链接，多个链接请分行填写" rows=9 style="width:99%; font-family:'Lucida Console'; font-size:12px;background:transparent;border:1px solid #91071f;color:#FFFFFF;" id="ss_base64_links" name="ss_base64_links" title="" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"></textarea>
													</td>
												</tr>
												<tr>
													<th width="35%">操作</th>
										...
										<div id="tablet_6" style="display: none;margin:-1px 0px 0px 0px;border:1px solid #91071f;">
											<table style="margin:-1px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" >
												...
												<tr>
													<th>插件触发重启设定&nbsp;&nbsp;<a class="hintstyle" href="javascript:void(0);" onclick="openssHint(109)"><font color="#ffcc00"><u>[说明]</u></font></a></th>
													<td>
														...
														<span id="ss_basic_tri_reboot_time_note">解析服务器IP，如果发生变更，则重启插件！</span>
												...
												<tr>
													<th>ss/ssr多核心支持&nbsp;&nbsp;<a class="hintstyle" href="javascript:void(0);" onclick="openssHint(108)"><font color="#ffcc00"><u>[说明]</u></font></a></th>
													<td>
														<input type="checkbox" id="ss_basic_mcore" onclick="verifyFields(this, 1);" checked="" />
													</td>
												</tr>												
											</table>
										</div>
										...
										<div id="warn" style="display: none;font-size: 20px;position: static;" class="formfontdesc" id="cmdDesc"><i></i></div>
										<div id="warn1" style="display: none;font-size: 20px;position: static;" class="formfontdesc" id="cmdDesc"><i></i></div>
									</td>
								</tr>
							</table>
						</div>
